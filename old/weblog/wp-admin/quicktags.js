...
function edButton(id, display, tagStart, tagEnd, access, open, titletag) {
...
function edShowButton(button, i) {
	if (button.id == 'ed_img') {
		...
		document.write('<input type="button" id="' + button.id + '" accesskey="' + button.access + '" class="ed_button" onclick="edInsertLink(edCanvas, ' + i + ');" value="' + button.display + '" title="' + button.titletag + '" />');
	}
	else {
		document.write('<input type="button" id="' + button.id + '" accesskey="' + button.access + '" class="ed_button" onclick="edInsertTag(edCanvas, ' + i + ');" value="' + button.display + '"  title="' + button.titletag + '" />');
	}
}
