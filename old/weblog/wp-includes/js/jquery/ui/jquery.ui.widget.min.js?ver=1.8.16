...
<html>
	<head>
		...
		<script type="text/javascript">archive_analytics.values.server_name="wwwb-app4.us.archive.org";archive_analytics.values.server_ms=38;</script>
...
<!-- /HEADER -->
        ...
        <div id="positionHome">
		    ...
		    <input type="text" name="url" value="/weblog/wp-includes/js/jquery/ui/jquery.ui.widget.min.js?ver=1.8.16" size="40" onfocus="javascript:this.focus();this.select();" >
            ...
            <div id="error">
			    ...
			    <p>Want to search for all archived pages under <a href="/web/form-submit.jsp?type=prefixquery&amp;url=/weblog/wp-includes/js/jquery/ui/">/weblog/wp-includes/js/jquery/ui/</a> ?</p>
