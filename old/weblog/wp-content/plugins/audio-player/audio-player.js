...
<html>
	<head>
		...
		<script type="text/javascript">archive_analytics.values.server_name="wwwb-app36.us.archive.org";archive_analytics.values.server_ms=33;</script>
...
<!-- /HEADER -->
        ...
        <div id="positionHome">
		    ...
		    <input type="text" name="url" value="/weblog/wp-content/plugins/audio-player/audio-player.js" size="40" onfocus="javascript:this.focus();this.select();" >
            ...
            <div id="error">
			    ...
			    <p>Want to search for all archived pages under <a href="/web/form-submit.jsp?type=prefixquery&amp;url=/weblog/wp-content/plugins/audio-player/">/weblog/wp-content/plugins/audio-player/</a> ?</p>
