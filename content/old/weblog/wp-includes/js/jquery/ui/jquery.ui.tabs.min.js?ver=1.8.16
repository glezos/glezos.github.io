...
<html>
	<head>
		...
		<script type="text/javascript">archive_analytics.values.server_name="wwwb-app17.us.archive.org";archive_analytics.values.server_ms=80;</script>
...
<!-- /HEADER -->
        ...
        <div id="positionHome">
		    ...
		    <input type="text" name="url" value="/weblog/wp-includes/js/jquery/ui/jquery.ui.tabs.min.js?ver=1.8.16" size="40" onfocus="javascript:this.focus();this.select();" >
